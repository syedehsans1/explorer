<script lang="ts" setup>
  ...
  import { PageRequest, type Pagination, type Gateway, type SlashingParam } from '@/types';
...
<template>
  <div class="mb-[2vh]">
    ...
    <div class="bg-base-200 dark:bg-base-100 rounded-xl px-2 pt-2 pb-2 gatewaysContainer" style="max-height: 78vh; overflow: auto">
